...
const uint8_t lora_rdpara2[]={"AT+STATUS="};//设备当前状态

const uint8_t lora_setpara1[]={"AT+CJOINMODE"};
const uint8_t lora_setpara2[]={"AT+DEVEUI="};
const uint8_t lora_setpara3[]={"AT+APPEUI="};
const uint8_t lora_setpara4[]={"AT+APPKEY="};
